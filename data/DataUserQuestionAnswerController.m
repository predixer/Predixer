...
- (void)getAnswer
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://www.predixer.com/svc/predixerservice.svc/GetUserQuestionAnswer?id=%@&fb=%@&que=%@", userID, facebookUserID, questionID];
