//
//  predixerHistoryDetailsViewController.m
//  predict
//
...
@interface predixerHistoryDetailsViewController ()

@end

@implementation predixerHistoryDetailsViewController
...
- (void) viewWillDisappear:(BOOL)animated
{
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"didFinishLoadingQuestion" object:nil];
