//
//  predixerPlayEntertainmentDetailsViewController.m
//  predict
//
...
@interface predixerPlayEntertainmentDetailsViewController ()

@end

@implementation predixerPlayEntertainmentDetailsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([answersDataController countOfList] != 0)
    {
        ...
        if (checkedAnswer == YES) {
            ...
            cell.detailTextLabel.font = [UIFont fontWithName: @"Comic Sans MS" size:14];
