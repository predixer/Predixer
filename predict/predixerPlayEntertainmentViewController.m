//
//  predixerPlayEntertainmentViewController.m
//  predict
//
...
#import "predixerPlayEntertainmentDetailsViewController.h"
#import "DataQuestions.h"
#import "DataQuestionsController.h"
#import "predixerSettingsViewControllerViewController.h"


@interface predixerPlayEntertainmentViewController ()

@end

@implementation predixerPlayEntertainmentViewController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.navigationController.title = @"Play Game";
    }
    return self;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    predixerPlayEntertainmentDetailsViewController *details = [[predixerPlayEntertainmentDetailsViewController alloc] initWithQuestion:dataQuestions];
