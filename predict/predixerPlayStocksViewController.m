//
//  predixerPlayStocksViewController.m
//  predict
//
...
@interface predixerPlayStocksViewController ()

@end

@implementation predixerPlayStocksViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    predixerPlayStocksDetailsViewController *details = [[predixerPlayStocksDetailsViewController alloc] initWithQuestion:dataQuestions];
